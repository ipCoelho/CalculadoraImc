...
function toClassificateImc(imc){
    ...
    if (imc < 18.5){
        ...
        category = 'com peso ideal. Parabéns!'
    } else if (imc < 30) {
        ...
        category = 'com obesidade grau III'
    }
    return category
}
...
function showResult() {
    ...
    if (camposValidos()) {
        ...
        result.textContent = `${name} seu IMC é ${imc.toFixed(1)} e você está ${classification}` // toFixed() -> Method to fix the decimal points.
    } else {
